...
import { addElementInContainer, createSection, createHeadingTitle, clearContainer, } from "../dom/index.js";
...
function createTaskDetailSection(taskId) {
    ...
    `;
          ...
          <img class="avatar" src="${getAvatarPath(comment.user_id, (_a = author === null || author === void 0 ? void 0 : author.getGender()) !== null && _a !== void 0 ? _a : "Male")}" alt="${(author === null || author === void 0 ? void 0 : author.getName()) || "Usuário"}" />
          <div class="bubble">
