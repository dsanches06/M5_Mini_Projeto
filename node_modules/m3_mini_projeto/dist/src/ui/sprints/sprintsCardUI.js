...
import { TaskService, UserService, SprintService, SprintTaskService, } from "../../services/index.js";
...
export function renderSprintsCards(sprints, targetContainer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!gridContainer) {
            gridContainer = document.querySelector("#sprintsGridContainer");
        }
        if (!gridContainer) {
...
function createSprintCard(sprint) {
        ...
        deleteBtn.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield showConfirmDialog(`Tem certeza que deseja excluir o sprint "${sprint.name}"?`)) {
                try {
                    ...
                    yield renderSprintsCards(currentSprints);
                }
                catch (error) {
  ...
  <i class="fas fa-minus"></i>`;
        ...
        const statusText = ((_b = sprint.getStatus) === null || _b === void 0 ? void 0 : _b.call(sprint)) || sprint.status || "Ativo";
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (availableTasks.length === 0) {
                showInfoBanner("Não há tarefas disponíveis sem vínculo ao sprint.", "warning");
                return;
            }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (sprintRelations.length === 0) {
                showInfoBanner("Este sprint não tem tarefas associadas.", "warning");
                return;
            }
            ...
            if (associatedTasks.length === 0) {
                showInfoBanner("Não foi possível encontrar tarefas associadas a este sprint.", "warning");
                return;
            }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        items.forEach((item) => {
            ...
            button.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    if (mode === "link") {
                        yield SprintTaskService.createSprintTask({
                            sprint_id: sprint.id,
                            task_id: (_b = (_a = task.getId) === null || _a === void 0 ? void 0 : _a.call(task)) !== null && _b !== void 0 ? _b : task.id,
                        });
                        showInfoBanner(`Tarefa "${getTaskLabel(task)}" associada ao sprint.`, "success");
                    }
                    else {
                        yield SprintTaskService.deleteSprintTask(relation.id);
                        showInfoBanner(`Tarefa "${getTaskLabel(task)}" desassociada do sprint.`, "success");
                    }
                    modal.remove();
                    const cardsContainer = document.querySelector("#projectSprintsContainer");
                    if (cardsContainer) {
                        const currentSprints = yield SprintService.getSprints();
                        yield renderSprintsCards(currentSprints, cardsContainer);
                    }
                }
                catch (error) {
                    console.error(error);
                    showInfoBanner("Erro ao atualizar a associação da tarefa.", "error");
                }
            }));
