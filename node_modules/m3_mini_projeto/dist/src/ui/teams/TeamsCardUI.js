...
export function renderTeamsCards(teams) {
    return __awaiter(this, void 0, void 0, function* () {
        let gridContainer = document.querySelector("#teamsGridContainer");
        if (!gridContainer) {
...
function createTeamCard(team) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        deleteBtn.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield showConfirmDialog(`Tem certeza que deseja excluir a equipe "${team.name}"?`)) {
                try {
                    ...
                    yield renderTeamsCards(currentTeams);
                }
                catch (error) {
        ...
        try {
            const allTeamMembers = yield TeamMemberService.getTeamMembers();
        ...
        try {
            ...
            availableUsers.forEach((user) => {
                ...
                button.addEventListener("click", (e) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        if (action === "add") {
                            yield TeamMemberService.createTeamMember({
                                team_id: teamId,
                                user_id: user.getId(),
                            });
                            ...
                            const teamMember = teamMembers.find((m) => m.user_id === user.getId());
                            if (teamMember && teamMember.id) {
                                yield TeamMemberService.deleteTeamMember(teamMember.id);
