    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (finishedProjectsBtn) {
            finishedProjectsBtn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                const allProjects = yield ProjectService.getProjects();
                const finishedProjects = allProjects.filter((p) => p.getStatus() === "Terminado");
        ...
        if (addProjectBtn) {
            addProjectBtn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                yield renderProjectModal();
            }));
        }
        // Event listener para ordenar projetos
        const sortProjectsBtn = document.querySelector("#sortProjectsBtn");
        if (sortProjectsBtn) {
