import { NotificationAPIRequest } from "@api/dto/typesDTO.js";
...
export class NotificationService {
  ...
  static async getNotifications(): Promise<NotificationAPIRequest[]> {
    return await fetchNotifications.getNotifications();
  }

  /* Obtém uma notificação por ID da API */
  static async getNotificationById(id: number): Promise<NotificationAPIRequest | null> {
    return await fetchNotifications.getNotificationById(id);
  }

  /* Cria uma nova notificação na API */
  static async createNotification(
    notification: NotificationAPIRequest,
  ): Promise<NotificationAPIRequest | null> {
