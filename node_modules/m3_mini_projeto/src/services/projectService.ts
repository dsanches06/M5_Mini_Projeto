...
import { ProjectAPIRequest, ProjectStatusAPIRequest } from "../api/dto/index.js";
...
export class ProjectService {
  ...
  static async createProject(project: ProjectAPIRequest): Promise<Project | null> {
    return await fetchProjects.createProject(project);
  }

  /* Função para atualizar um projeto existente */
  static async updateProject(project: ProjectAPIRequest): Promise<Project | null> {
