import { ProjectPermissionAPIRequest } from "@api/dto/typesDTO.js";
...
export class ProjectPermissionService {
  ...
  static async getProjectPermissions(): Promise<ProjectPermissionAPIRequest[]> {
    return await fetchProjectPermissions.getProjectPermissions();
  }

  /* Função para obter uma permissão de projeto por ID */
  static async getProjectPermissionById(id: number): Promise<ProjectPermissionAPIRequest | null> {
    return await fetchProjectPermissions.getProjectPermissionById(id);
  }

  /* Função para criar uma nova permissão de projeto */
  static async createProjectPermission(permission: any): Promise<ProjectPermissionAPIRequest | null> {
  ...
  static async updateProjectPermission(id: number, permission: any): Promise<ProjectPermissionAPIRequest | null> {
