import { ProjectStatusAPIRequest } from "../api/dto/index.js";
...
export class ProjectStatusService {
  ...
  static async getProjectStatuses(): Promise<ProjectStatusAPIRequest[]> {
    return await fetchProjectStatus.getProjectStatuses();
  }

  /* Função para obter um status de projeto por ID */
  static async getProjectStatusById(id: number): Promise<ProjectStatusAPIRequest | null> {
    return await fetchProjectStatus.getProjectStatusById(id);
  }

  /* Função para criar um novo status de projeto */
  static async createProjectStatus(status: any): Promise<ProjectStatusAPIRequest | null> {
    return await fetchProjectStatus.createProjectStatus(status);
  }

  /* Função para atualizar um status de projeto existente */
  static async updateProjectStatus(id: number, status: any): Promise<ProjectStatusAPIRequest | null> {
