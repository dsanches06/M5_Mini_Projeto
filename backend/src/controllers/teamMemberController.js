...
export const getTeamMembers = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: `Error fetching team members: ${error.message}` });
  }
};
...
export const createTeamMember = async (req, res) => {
  try {
    ...
    res.status(400).json({ error: `Error creating team member: ${error.message}` });
  }
};
...
export const updateTeamMember = async (req, res) => {
  try {
    ...
    res.status(400).json({ error: `Error updating team member: ${error.message}` });
  }
};
...
export const deleteTeamMember = async (req, res) => {
  try {
    ...
    res.status(400).json({ error: `Error deleting team member: ${error.message}` });
  }
};
